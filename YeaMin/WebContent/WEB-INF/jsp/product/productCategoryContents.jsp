        ...
        grid: {
            ...
            bind: function(){
                this.target.setConfig({
                    ...
                    colGroup: [
                        {key:"product_category_no", label:"상품 카테고리 번호", width:"200", align:"center"},
                        {key:"product_category_name", label:"상품 카테고리 이름", width:"200", align:"center"},
                        {key:"product_category_order_by", label:"상품 카테고리 순서", width:"200", align:"center"},
                        {key:"product_cnt", label:"상품 수", width:"200", align:"center"}
                    ],
                    body: {
                        ondblclick: function(){
                        	// trace(this.index);

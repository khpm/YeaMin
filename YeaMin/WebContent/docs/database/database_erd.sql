...
(
	-- 가게 이름
	STORE_NAME varchar2(10) NOT NULL UNIQUE,
	-- 가게 전화 번호
	STORE_TEL varchar2(13) NOT NULL,
	-- 가게 주소
	STORE_ADDR varchar2(100) NOT NULL,
	-- 가게 설명
	STORE_DESC varchar2(1000) NOT NULL,
	-- 가가 주중 영업 시간
	STORE_WEEK_BUSINESS_TIME varchar2(20) NOT NULL,
	STORE_WEEKEND_BUSINESS_TIME varchar2(20) NOT NULL
);
...
COMMENT ON COLUMN YM_STORE.STORE_WEEK_BUSINESS_TIME IS '가가 주중 영업 시간';
